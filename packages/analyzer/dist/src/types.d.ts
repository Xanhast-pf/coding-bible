...
export declare const analyzerLanguages: readonly ["tsx", "ts", "jsx", "js", "css", "graphql"];
export type AnalyzerLanguage = (typeof analyzerLanguages)[number];
export declare const analyzerPacks: readonly ["accessibility", "ai", "apollo", "architecture", "core", "css", "dependencies", "feature-flags", "graphql", "internationalization", "javascript", "legend-state", "nextjs", "performance", "react", "redux", "tanstack-query", "testing", "typescript", "workflow"];
...
export declare const analyzerFindingImpacts: readonly ["high", "medium", "low"];
export type AnalyzerFindingImpact = (typeof analyzerFindingImpacts)[number];
export declare const analyzerFindingConfidences: readonly ["certain", "strong", "contextual"];
export type AnalyzerFindingConfidence = (typeof analyzerFindingConfidences)[number];
