...
export const createRangeFinding = (context, start, end, details) => {
    ...
    const startPosition = context.sourceFile.getLineAndCharacterOfPosition(boundedStart);
    const endPosition = context.sourceFile.getLineAndCharacterOfPosition(boundedEnd);
    const lineStart = context.sourceFile.getPositionOfLineAndCharacter(startPosition.line, 0);
