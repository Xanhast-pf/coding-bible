...
const detector = createSourceEvidenceDetector({
    ...
    profile: {
        ...
        impact: "high",
        contextNote: "This detector uses conservative static evidence for A11Y-005; review surrounding intent before changing behavior.",
    },
    message: "Do not communicate with color alone evidence was detected in this source.",
