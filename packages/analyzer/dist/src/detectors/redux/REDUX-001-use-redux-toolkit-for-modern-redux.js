...
const detector = createSourceEvidenceDetector({
    ...
    message: "Use Redux Toolkit for modern Redux evidence was detected in this source.",
    suggestion: "Apply REDUX-001: Use Redux Toolkit for modern Redux.",
    find: (context) => conjunctiveEvidence(context.source, [/\bswitch\s*\(\s*action\.type\s*\)/m, /\bcase\s+["']/m], [/createSlice\s*\(/m]),
});
