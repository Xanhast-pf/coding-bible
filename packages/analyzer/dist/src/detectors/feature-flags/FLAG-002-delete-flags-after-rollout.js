...
const detector = createSourceEvidenceDetector({
    ...
    profile: {
        ...
        impact: "high",
        contextNote: "This detector uses conservative static evidence for FLAG-002; review surrounding intent before changing behavior.",
    },
    ...
    find: (context) => conjunctiveEvidence(context.source, [/\bflags?\.\w+/m, /\brender(?:New|Legacy)\w*\s*\(/m], []),
});
