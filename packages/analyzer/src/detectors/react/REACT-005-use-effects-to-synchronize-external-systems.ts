...
const detector = createSourceEvidenceDetector({
  ...
  profile: {
    ...
    impact: "medium",
    contextNote:
      "This detector uses conservative static evidence for REACT-005; review surrounding intent before changing behavior.",
  },
  message:
    "Use effects to synchronize external systems evidence was detected in this source.",
