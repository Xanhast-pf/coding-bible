...
const detector = createSourceEvidenceDetector({
  ...
  profile: {
    ...
    impact: "low",
    contextNote:
      "This detector uses conservative static evidence for TS-006; review surrounding intent before changing behavior.",
  },
  message:
    "Model variants as discriminated unions evidence was detected in this source.",
