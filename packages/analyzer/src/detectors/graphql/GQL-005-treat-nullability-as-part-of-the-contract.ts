...
const detector = createSourceEvidenceDetector({
  ...
  profile: {
    ...
    impact: "high",
    contextNote:
      "This detector uses conservative static evidence for GQL-005; review surrounding intent before changing behavior.",
  },
  message:
    "Treat nullability as part of the contract evidence was detected in this source.",
