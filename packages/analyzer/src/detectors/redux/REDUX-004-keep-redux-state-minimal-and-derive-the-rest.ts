...
const detector = createSourceEvidenceDetector({
  ...
  profile: {
    ...
    impact: "high",
    contextNote:
      "This detector uses conservative static evidence for REDUX-004; review surrounding intent before changing behavior.",
  },
  message:
    "Keep Redux state minimal and derive the rest evidence was detected in this source.",
