...
const detector = createSourceEvidenceDetector({
    ...
    profile: {
        ...
        impact: "medium",
        contextNote: "This detector uses conservative static evidence for REDUX-005; review surrounding intent before changing behavior.",
    },
    message: "Normalize complex relational collections evidence was detected in this source.",
