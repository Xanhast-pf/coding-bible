...
const detector = createSourceEvidenceDetector({
    ...
    profile: {
        ...
        impact: "medium",
        contextNote: "This detector uses conservative static evidence for APOLLO-002; review surrounding intent before changing behavior.",
    },
    message: "Choose fetch policies deliberately evidence was detected in this source.",
