...
const detector = createSourceEvidenceDetector({
    ...
    message: "Keep persisted or synchronized state serializable evidence was detected in this source.",
    suggestion: "Apply LEGEND-006: Keep persisted or synchronized state serializable.",
